            ...
            <nav className="flex justify-between items-center">
                ...
                <div>
                    <ul className="flex items-center space-x-6">
                        <li>
                            <Link to={isAuthenticated ? "/Resources" : "/ResourcesNonMember"} className="text-lg hover:text-blue-500">
                                Explore resources
                            </Link>
                        </li>
                        <p>|</p>
                        <li>
                            <Link to={isAuthenticated ? "/FAQs" : "/FAQsNonMember"} className="text-lg hover:text-blue-500">
                                FAQs
                            </Link>
                        </li>
                    </ul>
